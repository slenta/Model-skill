...
class calculate_leadyear(object):
    ...
    def save_lead_corr(self):
        ...
        f = h5.File(f'{cfg.tmp_path}correlation/correlation_{self.start_year}_{self.end_year}_{lead_year}.hdf5', 'w')
...
class ly_series(object):
    ...
    def load_lead_corr(self, lead_year):
        ...
        f = h5.File(f'{cfg.tmp_path}correlation/correlation_{self.start_year}_{self.end_year}_{lead_year}.hdf5', 'r')
